        ...
        <div className='px-6 lg:px-24 py-16'>
            <div className="">
                ...
                <section className=' text-left'>
                    <h2 className="text-3xl font-bold text-cusred mb-4 border-b-2 border-cusred inline-block">Who the Centre is For</h2>
                ...
                <section className=' text-left mt-16'>
                    <h2 className="text-3xl font-bold text-cusred mb-4 border-b-2 border-cusred inline-block">A Brief Introduction</h2>
                    <p className="text-lg leading-relaxed">
